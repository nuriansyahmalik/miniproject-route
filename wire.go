...
var domainMenu = wire.NewSet(
	//services
	menu.ProvideMenuServiceImpl,
	wire.Bind(new(menu.MenuService), new(*menu.MenuServiceImpl)),
	//repository
	menu.ProvideMenuRepositoryMySQL,
	wire.Bind(new(menu.MenuRepository), new(*menu.MenuRepositoryMysql)),
)
...
var routing = wire.NewSet(
	wire.Struct(new(router.DomainHandlers), "FooBarBazHandler", "MenuHandler"),
